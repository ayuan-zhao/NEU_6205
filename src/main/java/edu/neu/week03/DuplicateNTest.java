...
/**
 * File Name: DuplicateNTest.java Sum of N base class
 *
...
public class DuplicateNTest {
    ...
    private void test1() {
        ...
        int[] d2 = {-1}; //Number of duplicates from alg 2
        {
            ...
            System.out.println(
                "O(n^2)Time O(1)Space Alg.  n = " + a.length + " Work = " + work0[0] + " CPU = " + d
                    + " secs");
        ...
        }
        {
            ...
            double d = u.timeInSec(endTime, startTime);
            System.out.println(
                "O(n)Time O(n)Space Alg.    n = " + a.length + " Work = " + work1[0] + " CPU = " + d
                    + " secs");
            boolean e = u.arrayEqual(a, copya);
            if (e == false) {
                System.out.println("You changed the content of given array a");
        ...
        }
        {
            ...
            double d = u.timeInSec(endTime, startTime);
            System.out.println(
                "O(n)Time O(1)Space Alg.    n = " + a.length + " Work = " + work2[0] + " CPU = " + d
                    + " secs");
            boolean e = u.arrayEqual(a, copya);
            if (e == false) {
                System.out.println("You changed the content of given array a");
